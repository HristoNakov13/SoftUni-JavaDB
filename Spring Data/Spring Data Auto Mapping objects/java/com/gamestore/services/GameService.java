...
import com.gamestore.domain.models.GameEditModel;
...
public class GameService {
    ...
    public String addGame(String[] args) throws ParseException {
        ...
        GameCreateModel gameCreateModel = new GameCreateModel(gameTitle, price, size, trailerID, args[4], args[5], releaseDate);
